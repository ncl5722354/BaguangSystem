<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="submap3.aspx.cs" Inherits="baguang_new.submap4" %>
...
<body>
    ...
    <div id="selected_title" class="selectecd_title_div">
        ...
        <input id="btn_qushi" runat="server" style="position:absolute;left:45%;top:10%;height:45%;width:3%;z-index:3;" type="image" src="image/查询.png"/>
    ...
    <div id="main_map" class="main_map">
         <img id="mainmap" class="map_bg" src="image/3.png"/>
         <!--地图上的七个点-->
...
<script type="text/javascript">
    ...
    $(function () {
      ...
      {%>
        ...
        draw_line(2934, 2994, 20, 85, 40, 40);
        draw_line(2994, 3014, 85, 95, 40, 75);
        draw_line(3014, 3074, 95, 10, 75, 75);

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="submap1.aspx.cs" Inherits="baguang_new.jsgrid.submap1" %>
...
<body>
    ...
    <div id="main_map" class="main_map">
         <img id="mainmap" class="map_bg" src="image/1.png"/>
         <!--地图上的七个点-->
        

        <label id="label_baojing" style="position:absolute;left:88%;top:20%;width:4%;height:4%;z-index:3;background-color:red;color:white;">报警</label>
         <label id="label_zhengchang" style="position:absolute;left:88%;top:40%;width:4%;height:4%;z-index:3;background-color:orange;color:white;">正常</label>
        <label id="label_lianghao" style="position:absolute;left:88%;top:60%;width:4%;height:4%;z-index:3;background-color:lightgreen;color:white;">良好</label>
        <label id="label_jihao" style="position:absolute;left:88%;top:80%;width:4%;height:4%;z-index:3;background-color:blue;color:white;">极好</label>
        
        <label id="label_biaochi" style="position:absolute;left:88%;top:10%;height:4%;width:10%;z-index:2;background-color:blue;color:white;text-align:center;border-color:black;border-style:solid;border-width:thick">标尺</label>
        ...
        <asp:Panel ID="canvas_panel" runat="server" CssClass="canvas_panel" BackColor="Gray">
            <canvas id="mycanvas" style="left:0%;top:0%;width:100%;height:100%;z-index:3;background-color:white;" >
            </canvas>
...
<script type="text/javascript">
    ...
    var orange_panel4s = document.createElement("orange_panel4s"); // 
   ...
   // alert(count);
    ...
    <%for (int i = 0; i < All_Value_Pos_Array.Count; i++)
      {%>
        ...
        // 153
        // 55 65 23 
        draw_line(2164, 2219, 70, 10, 36, 36);
    ...
    // 生成一条线
    function draw_line(start_pos,end_pos,start_x,end_x,start_y,end_y)
    {
        var pos_count = 0;
        var this_count = 0;
        ...
        for(var i=0;i<all_pos.length;i++)
        {
            try {
                ...
                if (all_pos[i] >= start_pos && all_pos[i] <= end_pos) {
                    ...
                    mypoint.style.top = ((end_y - start_y) / pos_count * this_count + start_y).toString() + "%";
                    mypoint.style.width = "3px";
                    mypoint.style.height = "3px";
                    ...
                    var panel = document.getElementById("main_map");
    ...
    //var pos = Get_KongGe_String(maplist[0], 1);               // 得到位置值
    //var value = Get_KongGe_String(maplist[0], 2);             // 得到位移量

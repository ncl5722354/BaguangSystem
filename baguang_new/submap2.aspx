<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="submap2.aspx.cs" Inherits="baguang_new.submap2" %>
...
<body>
    ...
    <div id="main_map" class="main_map">
         <img id="mainmap" class="map_bg" src="image/2.png"/>
         <!--地图上的七个点-->
...
<script type="text/javascript">
    ...
    $(function () {
      ...
      {%>
        ...
        draw_line(2561, 2606, 20, 85, 55, 55);
        draw_line(2561, 2576, 85, 95, 55, 87);

        draw_line(2576, 2577, 95, 94, 87, 87);
        draw_line(2577, 2582, 94, 89, 87, 71);
        draw_line(2582, 2584, 89, 85, 71, 71);
        draw_line(2584, 2589, 85, 89, 71, 87);
        draw_line(2589, 2590, 89, 88, 87, 87);
        draw_line(2590, 2595, 88, 84, 87, 71);
        draw_line(2595, 2597, 84, 78.5, 71, 71);
        draw_line(2597, 2602, 78.5, 82, 71, 87);
        draw_line(2602, 2603, 82, 81, 87, 87);
        draw_line(2603, 2608, 81, 77, 87, 71);
        draw_line(2608, 2610, 77, 72.5, 71, 71);
        draw_line(2610, 2615, 72.5, 75, 71, 87);
        draw_line(2615, 2616, 75, 74, 87, 87);
        draw_line(2616, 2621, 74, 71, 87, 71);
        draw_line(2621, 2623, 71, 66, 71, 71);
        draw_line(2623, 2628, 66, 68.5, 71, 87);
        draw_line(2628, 2629, 68.5, 67.5, 87, 87);
        draw_line(2629, 2634, 67.5, 65, 87, 71);
        draw_line(2634, 2636, 65, 59, 71, 71);
        draw_line(2636, 2641, 59, 61, 71, 87);
        draw_line(2641, 2642, 61, 60, 87, 87);
        draw_line(2642, 2647, 60, 58, 87, 71);
        draw_line(2647, 2649, 58, 53, 71, 71);
        draw_line(2649, 2654, 53, 54, 71, 87);
        draw_line(2654, 2655, 54, 53, 87, 87);
        draw_line(2655, 2660, 53, 52, 87, 71);
        draw_line(2660, 2662, 52, 46.5, 71, 71);
        draw_line(2662, 2667, 46.5, 47, 71, 87);
        draw_line(2667, 2668, 47, 46, 87, 87);
        draw_line(2668, 2673, 46, 45.5, 87, 71);
        draw_line(2673, 2675, 45.5, 40.5, 71, 71);
        draw_line(2675, 2680, 40.5, 40.5, 71, 87);
        draw_line(2680, 2681, 40.5, 39.5, 87, 87);
        draw_line(2681, 2686, 39.5, 40, 87, 71);
        draw_line(2686, 2688, 40, 35, 71, 71);
        draw_line(2688, 2693, 35, 34, 71, 87);
        draw_line(2693, 2694, 34, 33, 87, 87);
        draw_line(2694, 2699, 33, 34, 87, 71);
        draw_line(2699, 2701, 34, 29, 71, 71);
        draw_line(2701, 2706, 29, 27, 71, 87);
        draw_line(2706, 2707, 27, 26, 87, 87);
        draw_line(2707, 2712, 26, 28, 87, 71);
        draw_line(2712, 2714, 28, 22.5, 71, 71);
        draw_line(2714, 2719, 22.5, 20, 71, 87);
        draw_line(2719, 2720, 20, 19, 87, 87);
        draw_line(2720, 2725, 19, 21.5, 87, 71);
        draw_line(2725, 2727, 21.5, 17, 71, 71);
        draw_line(2727, 2732, 17, 13, 71, 87);
        draw_line();
    }
